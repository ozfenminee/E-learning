      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative">
        ...
        <div className="flex flex-col justify-center py-14 md:pr-16 xl:pr-40 md:py-0">
          <div className="text-center md:text-left space-y-6">
            ...
            >
              <button className="primary-btn bg-yellow-500 text-white rounded-full py-3 px-6">
                Get Started
              </button>
              <button className="flex justify-end items-center gap-2 font-semibold bg-yellow-500 text-white rounded-full py-3 px-6">
                <span className="w-5 h-10 bg-secondary/15 rounded-full flex justify-center items-center">
